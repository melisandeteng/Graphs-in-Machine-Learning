...
laplacian_param.regularization = 0.01; %regularization to add to the laplacian (\gamma_g)
...
soft_labels = soft_hfs(X, Y_masked, 0.95, 0.05, graph_param, laplacian_param);
