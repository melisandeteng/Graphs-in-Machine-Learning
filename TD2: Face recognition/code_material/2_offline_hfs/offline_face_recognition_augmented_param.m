function [accuracy] = offline_face_recognition_augmented_param(numtot, num, indbegin)
...
for i = 0:9
    for j = indbegin :indbegin+num-1
        ...
        X(sub2ind([10,num],i+1,j-indbegin+1),:) = gray_face(:)';
        Y(sub2ind([10,num],i+1,j-indbegin+1),1) = i+1;
    end
end
