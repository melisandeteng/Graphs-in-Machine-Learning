...
X = zeros(1000,EXTR_FRAME_SIZE^2);
Y = zeros(1000,1);
...
for i = 0:9
    for j = 1:100
        ...
        X(sub2ind([10,100],i+1,j),:) = gray_face(:)';
        Y(sub2ind([10,100],i+1,j),1) = i+1;
    end
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Y_masked = zeros(1000,1);
for i = 0 :9
  Y_masked(i*100+ 1:(i+1) * 100) =mask_labels(Y(i*100 + 1:(i+1) * 100), 4);
end;
...
%We didn't use soft clustering for face recognition
